...
\term{Ground wave}
{Siehe \link{Bodenwelle, Seite 33}.}
...
\term{Spektrogramm}
{Ein Spektrogramm zeigt den zeitlichen Verlauf des \link{Histogramms}. Die Signalstärke wird statt auf einer eigenen Achse mit der Farbe repräsentiert; so wird eine Achse frei für die Zeit.
...
{Auch \textit{Superhet} (für \textit{Superheterodynempfänger}) gennant. In diesen Empfängern wird die Eingangsfrequenz zuerst mit dem (anpassbaren) Lokaloszillator (LO) auf eine fixe \link{Zwischenfrequenz} gemischt -- für HF meist 455\,kHz oder 470\,kHz, für VHF 10.7\,MHz~--, wo das Signal dann gefiltert werden kann. Der Vorteil ist, dass für die fixe Zwischenfrequenz fixe Schaltkreise für Verstärkung und Filterung gebaut und verwendet werden können.
...
Professionelle Geräte verwenden teils zwei Zwischenfrequenzen, siehe \link{Doppelsuper}.
}