...
\section{Rufzeichen}
Jeder lizenzierte Amateurfunker hat ein weltweit einzigartiges Rufzeichen (Siehe \plink{sec:rufzeichen}{Rufzeichen}), genau wie Flugzeuge oder Schiffe. Schweizer Rufzeichen beginnen normalerweise mit \call{hb3} (geringere Anzahl Frequenzbänder) oder (CEPT-Ausweis) \call{hb9}. Des Weiteren werden \call{hb4}-Rufzeichen für Militärstationen und andere für spezielle Anlässe ausgestellt. \call{hb0}-Rufzeichen werden in Liechtenstein verwendet.
