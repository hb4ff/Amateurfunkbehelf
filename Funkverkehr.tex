...
Beispiele: \cw{rst 599 5nn}, \cw{pwr 1tt w}
...
Einigen Q-Codes kann ein bejahender oder verneinender Sinn gegeben werden, indem unmittelbar nach der Abkürzung «c» oder «no» übermittelt wird: \cw{qsk c}, \cw{qsk no}
...
Die Q-Codes werden zu Fragen, wenn ihnen ein Fragezeichen folgt. Die nachfolgende Liste führt die Bedeutung der Q-Codes sowohl als Frage wie auch als Antwort oder Mitteilung auf: \cw{qsx?}, \cw{qsx up 5 to 10}

Jenen Q-Codes, die mehrere numerierte Bedeutungen haben, ist die entsprechende Nummer unmittelbar nachgestellt. \cw{qsa1}, \cw{qrk3}
...
hpe cuagn sn es my qsl sure via \gap{buro/direct} =\\
